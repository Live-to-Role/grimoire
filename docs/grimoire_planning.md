...
- [ ] Folder scanning with file watching
- [ ] Cover image extraction (first page render)
- [ ] Basic metadata extraction (page count, file size, embedded metadata)
- [ ] Manual tagging system (game system, product type, level range)
- [ ] Search by title, tags, and metadata
- [ ] Filter by game system, product type, tags
- [ ] Grid and list view for library
- [ ] In-browser PDF viewer
- [ ] Collections (user-created groupings)
- [ ] Basic settings UI (folder paths, appearance)
...
#### Features
- [ ] BYOK configuration UI (OpenAI, Anthropic, Google, Ollama)
- [ ] AI product identification ("This PDF is Tomb of the Serpent Kings")
- [ ] AI game system detection
- [ ] AI-suggested tags (themes, content type)
- [ ] Full-text extraction using MarkItDown
...
#### Features
- [ ] Marker integration for layout-aware extraction
- [ ] Table of contents parsing
- [ ] Random table detection and extraction
- [ ] Stat block detection (system-aware)
- [ ] Map/image extraction
- [ ] Vector embeddings for semantic search
- [ ] Natural language queries ("Find swamp adventures for level 3")
